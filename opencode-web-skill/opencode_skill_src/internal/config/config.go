...
const (
	...
	CouncilHint    = "\n\nNeed to use @council subagent-tool when investigating/reviewing critical paths (e.g., high-complexity logic, important decisions, breaking changes, architecture-related work)."
)
